...
<html lang="en">
    <head>
		...
		<meta name="title" content="<?php echo $context->site->name; ?>">
		...
		<link type='text/css' rel="stylesheet" href="<?php echo $context->site->themeUri; ?>/assets/css/normalize.css">
		<link type='text/css' rel="stylesheet" href="<?php echo $context->site->themeUri; ?>/assets/css/style.css">
		
		<script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
		<script src="<?php echo $context->site->themeUri; ?>/assets/js/main.js"></script>
		
        <title><?php echo $context->current->meta->title; ?> | <?php echo $context->site->name; ?></title>
	</head>
    <body>
		<div id="container">
			<nav>
				<?php 
				foreach($context->query(array('root' => '/', 'deep' => 1)) as $page){ 
